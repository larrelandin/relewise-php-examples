...
// Associate user with company 'Northwind' and parent company 'Microsoft'
$parentCompany = Company::create('Microsoft');
$company = Company::create('Northwind');
...
echo '<h1>User with Company product view tracked!</h1>';
